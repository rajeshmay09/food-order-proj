...
const Footer1 = () => {
  return (
    <footer className="bg-lime-950 text-white py-6">
      <div className="container mx-auto px-2">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h4 className="text-lg font-semibold mb-4">About Us</h4>
            <p className="text-sm">
              Bringing your neighborhood's best to your doorstep, with every
              click. Connecting you to the heart of your community, one purchase
              at a time.
            </p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <ul>
              <li>
                <Link
                  href="/"
                  className="hover:text-yellow-500 no-underline text-white"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="w-full md:w-1/4">
            ...
            <div className="flex space-x-4">
              <div class="flex items-center gap-4">
                <Link
                  href="javascript:;"
                  class="p-2 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
                >
                  <svg
                ...
                <Link
                  href="javascript:;"
                  class="p-2 rounded-full bg-white text-gray-900 group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
        ...
        <div className="text-center mt-6">
          <p className="text-sm">
            © {new Date().getFullYear()} Clics Local. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
