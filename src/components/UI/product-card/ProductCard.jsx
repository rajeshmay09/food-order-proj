...
const ProductCard = (props) => {
  ...
  return (
    <div className="w-72 bg-white shadow-md rounded-xl duration-500 border-8 border-cream shadow-xl transition-transform transform hover:scale-110 hover:shadow-xl">
      <Link to="#">
        <div class="absolute ml-52 mt-3 max-w-fit rounded-full bg-white p-2 text-[#E74040]">
          <svg
        ...
        <img
          ...
          alt="Product"
          className="h-80 w-72 object-cover rounded-b-xl"
        />
        <div className="px-4 py-3 w-72">
          ...
          <div className="flex items-center">
            ...
            <p class="text-sm text-gray-600 cursor-auto ml-2 line-through mb-0">
              $199
            </p>
